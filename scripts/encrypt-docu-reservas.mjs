...
const INPUT      = '_site/docu-reservas/index.html';
...
console.log('✓ docu-reservas/index.html — cifrada con AES-256-GCM');
...
<head>
  ...
  <title>Galería — Guía de Burgos</title>
